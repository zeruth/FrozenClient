...
Generated 2026-09-24 04:01 by `tools/recomp/recomp.py`. Do not edit; put facts in `tools/recomp/overrides.json`
...
| mapped to a frozen function | 3189 (+1) (11.7%) | 711.3k (12.9%) |
| &nbsp;&nbsp;ported | 2439 (+1) | 526.5k |
| &nbsp;&nbsp;stub (unimplemented body) | 690 (=) | 137.7k |
| &nbsp;&nbsp;verified (override) | 14 (=) | 3.0k |
| **faithful** (linked, not stub, call order >= 80%) | **1253 (=) (4.6%)** | **164.7k (3.0%)** |
| unmapped | 23971 | 4.69M |
| world spine (reachable from OnFrameRender) | 5529, mapped 573 (+1) (10.4%) | |
| &nbsp;&nbsp;render spine (world update + map + M2 scene) | 5797, mapped 583 (+1) (10.1%) | |
| **render surface** (the modules that draw the world) | **4589, mapped 279 (=) (6.1%)** | |
| frozen functions (src/, from PDB + source) | 12317, stubs 1819 | |

Match evidence: annotated 961, callgraph 183, callorder 127, cvar 32, handler 29, order 150, override 260, sticky 21, string 319, table 1107. Module anchors: 1479 assert strings.

`order` and `sticky` are POSITIONAL: neither says anything about what the function does, only where it sits. `order` lays frozen's definitions onto the reference's addresses between two anchors whenever the two counts happen to be equal, so one unported function or one helper frozen invented shifts every pair in the run. It has been checked closely three times, each time because a fresh tag put a run next to something already read, and all three runs were wrong. Treat a link of either kind as a question. See tools/recomp/README.md under the order matcher.

Previous run: 2026-09-24 03:58 -- mapped 3188, ported 2438, stub 690, spine mapped 572.
