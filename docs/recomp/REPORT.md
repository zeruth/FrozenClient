...
Generated 2026-09-18 18:18 by `tools/recomp/recomp.py`. Do not edit; put facts in `tools/recomp/overrides.json`
...
| mapped to a whoa function | 1543 (=) (5.7%) | 364.3k (6.6%) |
| &nbsp;&nbsp;ported | 1065 (=) | 243.7k |
| &nbsp;&nbsp;stub (WHOA_UNIMPLEMENTED) | 455 (=) | 92.6k |
| &nbsp;&nbsp;verified (override) | 15 (=) | 3.1k |
| **faithful** (linked, not stub, call order >= 80%) | **255 (=) (0.9%)** | **38.9k (0.7%)** |
| unmapped | 25618 | 5.05M |
| world spine (reachable from OnFrameRender) | 5530, mapped 173 (=) (3.1%) | |
| whoa functions (src/, from PDB + source) | 10614, stubs 885 | |

Match evidence: annotated 95, callgraph 63, callorder 89, handler 27, override 76, string 264, table 929. Module anchors: 1479 assert strings.

Previous run: 2026-09-18 18:17 -- mapped 1543, ported 1065, stub 455, spine mapped 173.
...
| ConsoleVar.cpp | 243 | 36.1k | 40 (16.5%) | 19.9% | 0 | 0 | 68 |
...
| Client.cpp | 169 | 30.8k | 25 (14.8%) | 31.3% | 0 | 0 | 31 |
