...
Generated 2026-09-25 03:33 by `tools/recomp/recomp.py`. Do not edit; put facts in `tools/recomp/overrides.json`
...
|---|---:|---:|
| reference (non-thunk) | 27124 | 5.38M |
| mapped to a frozen function | 3433 (=) (12.7%) | 773.7k (14.0%) |
| &nbsp;&nbsp;ported | 2762 (=) | 600.1k |
| &nbsp;&nbsp;stub (unimplemented body) | 616 (=) | 130.9k |
| &nbsp;&nbsp;verified (override) | 14 (=) | 3.0k |
| **faithful** (linked, not stub, call order >= 80%) | **1475 (=) (5.4%)** | **199.8k (3.6%)** |
| unmapped | 23691 | 4.63M |
| world spine (reachable from OnFrameRender) | 5509, mapped 760 (=) (13.8%) | |
| &nbsp;&nbsp;render spine (world update + map + M2 scene) | 5777, mapped 770 (=) (13.3%) | |
| **render surface** (the modules that draw the world) | **4560, mapped 447 (=) (9.8%)** | |
| frozen functions (src/, from PDB + source) | 12629, stubs 1740 | |

Match evidence: annotated 1259, callgraph 200, callorder 125, cvar 32, handler 29, order 149, override 273, sticky 22, string 301, table 1043. Module anchors: 1479 assert strings.

`order` and `sticky` are POSITIONAL: neither says anything about what the function does, only where it sits. `order` lays frozen's definitions onto the reference's addresses between two anchors whenever the two counts happen to be equal, so one unported function or one helper frozen invented shifts every pair in the run. It has been checked closely three times, each time because a fresh tag put a run next to something already read, and all three runs were wrong. Treat a link of either kind as a question. See tools/recomp/README.md under the order matcher.

Previous run: 2026-09-25 03:32 -- mapped 3433, ported 2762, stub 616, spine mapped 760.

## Lua API coverage (binding tables)

The reference registers 2964 Lua bindings across 100 tables (widget methods per class, and the global function blocks). frozen registers 2924 of them (=); 1411 of those are stubs (a WHOA_UNIMPLEMENTED body, or one of the WHOA_LUA_STUB bindings in MiscScriptStubs.cpp) (=). A missing name is a FrameXML call that raises "attempt to call a nil value"; a stub returns nothing, which is the arity bug class tools/arity.py hunts.

| ref table | entries | frozen array | missing | stubbed | first missing / stubbed names |
|---|---:|---|---:|---:|---|
| 00ac80b0 (FrameXML_Debug..) | 310 | `s_ScriptFunctions` | 0 | 158 |  / stubs: ReloadUI, RegisterForSave, RegisterForSavePerCharacter, SetLayoutMode ... |
| 00ad0030 (CalendarGetMonthNames..) | 95 | `s_stubs` | 0 | 92 |  / stubs: CalendarGetMonthNames, CalendarGetWeekdayNames, CalendarGetMinDate, CalendarGetMaxDate ... |
| 00ac7a58 (SendChatMessage..) | 89 | `s_ScriptFunctions` | 0 | 57 |  / stubs: SendChatMessage, SendAddonMessage, SendSystemMessage, GetLanguageByIndex ... |
...
| 00ac3e00 (IsShiftKeyDown..) | 113 | `s_ScriptFunctions` | 0 | 43 |  / stubs: QuitGameAndRunLauncher, LaunchURL, PatchDownloadProgress, PatchDownloadCancel ... |
...
| 00ad1270 (GetInventorySlotInfo..) | 33 | `s_ScriptFunctions` | 0 | 17 |  / stubs: GetInventoryItemsForSlot, GetInventoryItemCooldown, GetInventoryItemGems, PickupInventoryItem ... |
...
| 00ace790 (GetNumRaidMembers..) | 20 | `s_ScriptFunctions` | 0 | 9 |  / stubs: GetRaidRosterInfo, SetRaidRosterSelection, GetRaidRosterSelection, SetRaidSubgroup ... |
...
| ComSatSoundIOSoundEngine.cpp | 975 | 189.6k | 57 (5.8%) | 0.2% | 0 | 0 | 107 |
| Unit_C.cpp | 705 | 182.3k | 11 (1.6%) | 1.0% | 0 | 0 | 294 |
| Player_C.cpp | 736 | 148.3k | 14 (1.9%) | 6.1% | 0 | 0 | 163 |
| HealthBar.cpp | 448 | 102.9k | 8 (1.8%) | 3.6% | 0 | 0 | 68 |
| M2Scene.cpp | 283 | 101.1k | 97 (34.3%) | 50.7% | 7 | 0 | 210 |
| CGxDeviceD3d9Ex.cpp | 238 | 98.4k | 15 (6.3%) | 8.3% | 0 | 0 | 1 |
| GameUI.cpp | 491 | 96.4k | 200 (40.7%) | 45.3% | 86 | 0 | 73 |
| Spell_C.cpp | 355 | 86.2k | 16 (4.5%) | 5.7% | 0 | 0 | 121 |
| Tooltip.cpp | 151 | 86.0k | 75 (49.7%) | 62.9% | 38 | 1 | 16 |
| ChatFrame.cpp | 349 | 82.2k | 93 (26.6%) | 15.3% | 33 | 2 | 36 |
| lmemPool.cpp | 342 | 80.2k | 78 (22.8%) | 32.1% | 0 | 0 | 107 |
| Map.cpp | 235 | 77.2k | 4 (1.7%) | 3.6% | 0 | 0 | 141 |
| SpellCast.cpp | 261 | 70.6k | 0 (0.0%) | 0.0% | 0 | 0 | 7 |
| WorldParam.cpp | 185 | 63.6k | 32 (17.3%) | 20.2% | 3 | 0 | 116 |
| fmod_systemi.cpp | 222 | 62.1k | 0 (0.0%) | 0.0% | 0 | 0 | 99 |
| InputControl.cpp | 287 | 61.8k | 30 (10.5%) | 18.3% | 10 | 0 | 115 |
| SoundEngine.cpp | 406 | 59.7k | 16 (3.9%) | 17.6% | 0 | 0 | 58 |
| SEvt.cpp | 242 | 59.1k | 34 (14.0%) | 7.7% | 8 | 0 | 111 |
| CreepTendril.cpp | 1415 | 58.5k | 0 (0.0%) | 0.0% | 0 | 0 | 2 |
| SpellBookFrame.cpp | 246 | 57.0k | 41 (16.7%) | 13.2% | 10 | 0 | 15 |
...
| Minigame_C.cpp | 352 | 50.8k | 194 (55.1%) | 43.3% | 0 | 0 | 68 |
| LFGInfo.cpp | 229 | 47.7k | 29 (12.7%) | 13.0% | 10 | 0 | 7 |
| ScriptEvents.cpp | 225 | 46.9k | 167 (74.2%) | 71.8% | 27 | 0 | 26 |
| M2Shared.cpp | 65 | 45.9k | 10 (15.4%) | 7.7% | 1 | 0 | 19 |
| CSimpleHyperlinkedFrame.cpp | 195 | 45.6k | 74 (37.9%) | 43.6% | 0 | 0 | 119 |
...
| framing.c | 125 | 38.8k | 35 (28.0%) | 53.0% | 0 | 0 | 39 |
| DBCache.cpp | 236 | 38.8k | 36 (15.3%) | 10.2% | 0 | 0 | 83 |
| GameObject_C.cpp | 285 | 38.0k | 4 (1.4%) | 1.1% | 0 | 0 | 59 |
| GxuFontMiscClasses.cpp | 156 | 37.5k | 6 (3.8%) | 10.2% | 0 | 0 | 86 |
| MapChunk.cpp | 129 | 37.2k | 30 (23.3%) | 28.9% | 1 | 0 | 85 |
| ConsoleVar.cpp | 243 | 36.1k | 74 (30.5%) | 30.0% | 2 | 0 | 68 |
| CSimpleFrameScript.cpp | 242 | 35.7k | 206 (85.1%) | 88.9% | 9 | 1 | 4 |
| TextureBlob.cpp | 214 | 34.6k | 33 (15.4%) | 19.0% | 0 | 0 | 84 |
| AchievementInfo.cpp | 179 | 33.7k | 62 (34.6%) | 32.0% | 59 | 0 | 0 |
...
| PaperDollInfoFrame.cpp | 111 | 25.0k | 29 (26.1%) | 27.2% | 12 | 0 | 8 |
| CSimpleAnim.cpp | 141 | 24.4k | 51 (36.2%) | 58.7% | 2 | 2 | 7 |
| TalentInfo.cpp | 141 | 24.1k | 5 (3.5%) | 2.6% | 4 | 0 | 1 |
...
| Cursor.cpp | 117 | 20.7k | 4 (3.4%) | 5.4% | 0 | 0 | 19 |
...
| CSimpleMovieFrame.cpp | 128 | 19.6k | 48 (37.5%) | 35.7% | 4 | 1 | 2 |
| CheckExecutableSignature.cpp | 94 | 19.4k | 4 (4.3%) | 7.8% | 0 | 0 | 28 |
...
| AddOns.cpp | 101 | 18.1k | 3 (3.0%) | 0.5% | 0 | 0 | 7 |
| KnowledgeBase.cpp | 119 | 17.8k | 1 (0.8%) | 0.1% | 0 | 0 | 0 |
| MailInfo.cpp | 77 | 17.8k | 8 (10.4%) | 3.6% | 2 | 0 | 7 |
| DeclinedWords.cpp | 72 | 17.4k | 7 (9.7%) | 20.8% | 4 | 0 | 32 |
| OsClipboard.cpp | 74 | 16.8k | 21 (28.4%) | 30.5% | 0 | 0 | 45 |
| QuestTextParser.cpp | 87 | 16.5k | 12 (13.8%) | 4.7% | 1 | 0 | 33 |
...
| blp.cpp | 94 | 13.0k | 24 (25.5%) | 15.2% | 0 | 0 | 20 |
...
| CharacterCreation.cpp | 56 | 12.2k | 24 (42.9%) | 51.2% | 3 | 0 | 3 |
| aSfxDsp.cpp | 48 | 12.1k | 0 (0.0%) | 0.0% | 0 | 0 | 0 |
| EvtSched.cpp | 72 | 12.0k | 2 (2.8%) | 6.9% | 0 | 0 | 32 |
| SoundInterface2ZoneSounds.cpp | 68 | 11.6k | 0 (0.0%) | 0.0% | 0 | 0 | 23 |
| UIBindings.cpp | 59 | 11.5k | 21 (35.6%) | 44.3% | 13 | 0 | 4 |
| CSimpleMessageScrollFrame.cpp | 75 | 11.4k | 10 (13.3%) | 12.6% | 0 | 0 | 0 |
...
| RaidInfo.cpp | 33 | 10.1k | 17 (51.5%) | 43.5% | 8 | 0 | 1 |
...
| GuildInfo.cpp | 35 | 8.3k | 1 (2.9%) | 13.8% | 0 | 0 | 1 |
| MerchantFrame.cpp | 41 | 8.3k | 10 (24.4%) | 32.0% | 5 | 0 | 4 |
...
| SoundInterface2VoiceChat.cpp | 44 | 3.9k | 1 (2.3%) | 0.4% | 0 | 0 | 13 |
...
| TimeManager.cpp | 34 | 3.3k | 2 (5.9%) | 1.5% | 0 | 0 | 5 |
...
| Trade_C.cpp | 13 | 2.3k | 1 (7.7%) | 9.6% | 0 | 0 | 3 |
