...
Generated 2026-09-18 09:24 by `tools/recomp/recomp.py`. Do not edit; put facts in `tools/recomp/overrides.json`
...
|---|---:|---:|
| reference (non-thunk) | 27177 | 5.41M |
| mapped to a whoa function | 1425 (+23) (5.2%) | 324.9k (5.9%) |
| &nbsp;&nbsp;ported | 890 (+23) | 220.2k |
| &nbsp;&nbsp;stub (WHOA_UNIMPLEMENTED) | 535 (=) | 104.7k |
| &nbsp;&nbsp;verified (override) | 0 (=) | 0.0k |
| **faithful** (linked, not stub, call order >= 80%) | **129 (+9) (0.5%)** | **15.6k (0.3%)** |
| unmapped | 25752 | 5.09M |
| world spine (reachable from OnFrameRender) | 5545, mapped 156 (+14) (2.8%) | |
| whoa functions (src/, from PDB + source) | 10193, stubs 959 | |

Match evidence: annotated 106, callgraph 65, callorder 54, override 42, string 232, table 926. Module anchors: 1479 assert strings.

Previous run: 2026-09-18 09:21 -- mapped 1402, ported 867, stub 535, spine mapped 142.

## Lua API coverage (binding tables)

The reference registers 2512 Lua bindings across 151 tables (widget methods per class, and the global function blocks). whoa registers 936 of them (=); 532 of those are WHOA_UNIMPLEMENTED stubs (=). A missing name is a FrameXML call that raises "attempt to call a nil value"; a stub returns nothing, which is the arity bug class tools/arity.py hunts.
...
| 00b2d150 (SetFontObject..) | 23 | `SimpleHTMLMethods` | 0 | 22 |  / stubs: SetFontObject, GetFontObject, SetFont, GetFont ... |
...
| 00acebb8 (SetMaskTexture..) | 19 | `CGMinimapFrameMethods` | 4 | 15 | GetNumTrackingTypes, GetTrackingInfo, SetTracking, GetTrackingTexture / stubs: SetMaskTexture, SetIconTexture, SetBlipTexture, SetClassBlipTexture ... |
...
| 00b2cb10 (SetModel..) | 24 | `SimpleModelMethods` | 0 | 15 |  / stubs: GetModel, ClearModel, SetPosition, SetFacing ... |
...
| 00acf180 (SetFillTexture..) | 14 | `CGQuestPOIFrameMethods` | 0 | 14 |  / stubs: SetFillTexture, SetFillAlpha, SetBorderTexture, SetBorderAlpha ... |
...
| 00acf598 (CycleVariation..) | 8 | `CGTabardModelFrameMethods` | 0 | 8 |  / stubs: CycleVariation, GetUpperBackgroundFileName, GetLowerBackgroundFileName, GetUpperEmblemFileName ... |
...
| 00b2cdb8 (GetOrientation..) | 12 | `SimpleStatusBarMethods` | 0 | 7 |  / stubs: GetOrientation, SetOrientation, GetStatusBarTexture, SetStatusBarTexture ... |
...
| 00acfb28 (GetGMStatus..) | 6 | `s_ScriptFunctions` | 0 | 6 |  / stubs: GetGMStatus, GMSurveyQuestion, GMSurveyNumAnswers, GMSurveyAnswer ... |
...
| 00ad13a4 (SetCooldown..) | 5 | `CGCooldownMethods` | 0 | 5 |  / stubs: SetCooldown, SetReverse, GetReverse, SetDrawEdge ... |
...
| 00ac465c (ResetLights..) | 4 | `SimpleModelFFXMethods` | 0 | 4 |  / stubs: ResetLights, AddLight, AddCharacterLight, AddPetLight |
...
| 00acf514 (SetUnit..) | 4 | `CGCharacterModelBaseMethods` | 0 | 4 |  / stubs: SetUnit, SetCreature, RefreshUnit, SetRotation |
...
| 00ac41a8 (GetNumRealms..) | 7 | `s_ScriptFunctions` | 0 | 1 |  / stubs: SortRealms |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| DBClient.cpp | 1263 | 274.4k | 0 (0.0%) | 0.0% | 0 | 0 | 83 |
| OggDecompress.cpp | 1504 | 260.7k | 11 (0.7%) | 2.1% | 0 | 0 | 476 |
| ComSatSoundIOSoundEngine.cpp | 976 | 190.0k | 51 (5.2%) | 0.4% | 0 | 0 | 108 |
| Unit_C.cpp | 705 | 182.3k | 4 (0.6%) | 0.7% | 0 | 0 | 294 |
| Player_C.cpp | 738 | 148.4k | 1 (0.1%) | 0.1% | 0 | 0 | 165 |
| HealthBar.cpp | 448 | 102.9k | 0 (0.0%) | 0.0% | 0 | 0 | 68 |
| M2Scene.cpp | 283 | 101.1k | 9 (3.2%) | 2.5% | 0 | 0 | 210 |
| CGxDeviceD3d9Ex.cpp | 238 | 98.4k | 6 (2.5%) | 5.8% | 0 | 0 | 1 |
| GameUI.cpp | 491 | 96.4k | 41 (8.4%) | 17.1% | 29 | 0 | 73 |
| Spell_C.cpp | 355 | 86.2k | 3 (0.8%) | 2.2% | 0 | 0 | 121 |
| Tooltip.cpp | 151 | 86.0k | 69 (45.7%) | 26.9% | 51 | 0 | 16 |
| ChatFrame.cpp | 349 | 82.2k | 7 (2.0%) | 0.9% | 0 | 0 | 36 |
| lmemPool.cpp | 342 | 80.2k | 6 (1.8%) | 0.7% | 0 | 0 | 107 |
| Map.cpp | 238 | 77.5k | 2 (0.8%) | 2.7% | 0 | 0 | 144 |
| SpellCast.cpp | 261 | 70.6k | 0 (0.0%) | 0.0% | 0 | 0 | 7 |
| WorldParam.cpp | 187 | 64.3k | 3 (1.6%) | 3.6% | 0 | 0 | 118 |
| M2Shared.cpp | 66 | 63.3k | 1 (1.5%) | 1.0% | 0 | 0 | 20 |
| fmod_systemi.cpp | 222 | 62.1k | 0 (0.0%) | 0.0% | 0 | 0 | 99 |
| InputControl.cpp | 287 | 61.8k | 10 (3.5%) | 15.3% | 4 | 0 | 115 |
| SoundEngine.cpp | 406 | 59.7k | 10 (2.5%) | 16.5% | 0 | 0 | 58 |
| SEvt.cpp | 242 | 59.1k | 3 (1.2%) | 1.1% | 0 | 0 | 111 |
| CreepTendril.cpp | 1415 | 58.5k | 0 (0.0%) | 0.0% | 0 | 0 | 2 |
| SpellBookFrame.cpp | 246 | 57.0k | 19 (7.7%) | 7.3% | 7 | 0 | 15 |
| FFXEffects.cpp | 219 | 56.2k | 6 (2.7%) | 5.7% | 0 | 0 | 72 |
| PartyFrame.cpp | 304 | 55.3k | 69 (22.7%) | 31.2% | 56 | 0 | 11 |
| CSimpleAnimScript.cpp | 223 | 51.5k | 7 (3.1%) | 2.1% | 0 | 0 | 8 |
| Minigame_C.cpp | 352 | 50.8k | 26 (7.4%) | 3.1% | 0 | 0 | 68 |
| LFGInfo.cpp | 229 | 47.7k | 12 (5.2%) | 3.0% | 9 | 0 | 7 |
| ScriptEvents.cpp | 225 | 46.9k | 163 (72.4%) | 68.6% | 60 | 0 | 26 |
| CSimpleHyperlinkedFrame.cpp | 198 | 46.2k | 0 (0.0%) | 0.0% | 0 | 0 | 120 |
| ScanDLLGlue.cpp | 184 | 45.1k | 7 (3.8%) | 3.8% | 4 | 0 | 41 |
| CSimpleHTML.cpp | 364 | 44.4k | 196 (53.8%) | 59.0% | 98 | 0 | 0 |
| fmod_codec_it.cpp | 57 | 42.9k | 0 (0.0%) | 0.0% | 0 | 0 | 2 |
| asiolist.cpp | 172 | 42.5k | 0 (0.0%) | 0.0% | 0 | 0 | 4 |
| DetailDoodad.cpp | 163 | 41.4k | 0 (0.0%) | 0.0% | 0 | 0 | 72 |
| VehicleCamera_C.cpp | 95 | 40.7k | 0 (0.0%) | 0.0% | 0 | 0 | 39 |
| TextureCache.cpp | 252 | 38.9k | 6 (2.4%) | 5.5% | 0 | 0 | 79 |
| TradeSkillFrame.cpp | 163 | 38.8k | 0 (0.0%) | 0.0% | 0 | 0 | 23 |
| framing.c | 125 | 38.8k | 17 (13.6%) | 3.1% | 0 | 0 | 39 |
...
| MapChunk.cpp | 130 | 37.3k | 1 (0.8%) | 0.2% | 0 | 0 | 86 |
| ConsoleVar.cpp | 243 | 36.1k | 30 (12.3%) | 16.5% | 0 | 0 | 68 |
| CSimpleFrameScript.cpp | 242 | 35.7k | 57 (23.6%) | 32.8% | 23 | 0 | 4 |
| TextureBlob.cpp | 215 | 34.7k | 8 (3.7%) | 3.9% | 0 | 0 | 85 |
| AchievementInfo.cpp | 179 | 33.7k | 1 (0.6%) | 0.1% | 0 | 0 | 0 |
| Calendar.cpp | 110 | 32.5k | 0 (0.0%) | 0.0% | 0 | 0 | 1 |
| fmod_output_openal.cpp | 57 | 31.2k | 0 (0.0%) | 0.0% | 0 | 0 | 2 |
| UnitMissileTrajectory_C.cpp | 97 | 31.1k | 0 (0.0%) | 0.0% | 0 | 0 | 61 |
| MinimapFrame.cpp | 78 | 31.1k | 12 (15.4%) | 11.4% | 12 | 0 | 3 |
| XMLTree.cpp | 184 | 31.1k | 36 (19.6%) | 28.2% | 6 | 0 | 31 |
| MapChunkLiquid.cpp | 77 | 30.9k | 0 (0.0%) | 0.0% | 0 | 0 | 47 |
| Client.cpp | 169 | 30.8k | 23 (13.6%) | 26.6% | 0 | 0 | 31 |
| CGlueMgr.cpp | 183 | 28.9k | 41 (22.4%) | 36.6% | 3 | 0 | 1 |
| LoadingScreen.cpp | 201 | 28.7k | 8 (4.0%) | 10.0% | 0 | 0 | 80 |
| fmod_sample_software.cpp | 51 | 28.1k | 0 (0.0%) | 0.0% | 0 | 0 | 1 |
| CScriptRegion.cpp | 204 | 27.4k | 60 (29.4%) | 35.6% | 26 | 0 | 50 |
| UIMacros.cpp | 139 | 27.2k | 0 (0.0%) | 0.0% | 0 | 0 | 6 |
| CSimpleRender.cpp | 166 | 26.6k | 9 (5.4%) | 19.9% | 0 | 0 | 50 |
| UnitCombatLog_C.cpp | 106 | 26.2k | 0 (0.0%) | 0.0% | 0 | 0 | 33 |
| CSimpleFrame.cpp | 144 | 25.9k | 5 (3.5%) | 14.0% | 0 | 0 | 36 |
| GossipInfo.cpp | 174 | 25.4k | 14 (8.0%) | 5.3% | 14 | 0 | 5 |
| SoundInterface2Internal.cpp | 139 | 25.2k | 2 (1.4%) | 12.2% | 0 | 0 | 13 |
| PaperDollInfoFrame.cpp | 111 | 25.0k | 25 (22.5%) | 23.4% | 23 | 0 | 8 |
| CSimpleAnim.cpp | 141 | 24.4k | 26 (18.4%) | 25.4% | 6 | 0 | 7 |
...
| Texture.cpp | 146 | 22.2k | 8 (5.5%) | 8.3% | 0 | 0 | 75 |
| MapMem.cpp | 101 | 21.3k | 0 (0.0%) | 0.0% | 0 | 0 | 63 |
| Cursor.cpp | 117 | 20.7k | 1 (0.9%) | 1.8% | 0 | 0 | 19 |
| ObjectEffect.cpp | 82 | 20.6k | 0 (0.0%) | 0.0% | 0 | 0 | 34 |
| FriendList.cpp | 92 | 20.5k | 0 (0.0%) | 0.0% | 0 | 0 | 0 |
| CSimpleEditBox.cpp | 94 | 20.4k | 5 (5.3%) | 9.2% | 0 | 0 | 0 |
| CSimpleMovieFrame.cpp | 128 | 19.6k | 33 (25.8%) | 29.0% | 15 | 0 | 2 |
| CheckExecutableSignature.cpp | 95 | 19.5k | 1 (1.1%) | 2.7% | 0 | 0 | 29 |
| TaxiMapFrame.cpp | 98 | 19.5k | 1 (1.0%) | 0.6% | 0 | 0 | 3 |
| BattlenetLogin.cpp | 111 | 19.4k | 0 (0.0%) | 0.0% | 0 | 0 | 0 |
| Profile.cpp | 128 | 19.1k | 0 (0.0%) | 0.0% | 0 | 0 | 28 |
| DressUpModelFrame.cpp | 116 | 18.8k | 9 (7.8%) | 12.6% | 9 | 0 | 7 |
| AddOns.cpp | 101 | 18.1k | 1 (1.0%) | 0.2% | 0 | 0 | 7 |
| KnowledgeBase.cpp | 119 | 17.8k | 2 (1.7%) | 0.2% | 0 | 0 | 0 |
| MailInfo.cpp | 77 | 17.8k | 5 (6.5%) | 2.4% | 4 | 0 | 7 |
| DeclinedWords.cpp | 72 | 17.4k | 3 (4.2%) | 16.8% | 0 | 0 | 32 |
| OsClipboard.cpp | 74 | 16.8k | 2 (2.7%) | 3.6% | 0 | 0 | 45 |
| QuestTextParser.cpp | 87 | 16.5k | 3 (3.4%) | 1.2% | 3 | 0 | 33 |
...
| GxuFontUtil.cpp | 60 | 13.3k | 1 (1.7%) | 0.8% | 0 | 0 | 45 |
| EffectGlow.cpp | 64 | 13.1k | 1 (1.6%) | 6.2% | 0 | 0 | 5 |
| blp.cpp | 94 | 13.0k | 11 (11.7%) | 11.1% | 0 | 0 | 20 |
| fmod_output_wasapi.cpp | 68 | 12.8k | 0 (0.0%) | 0.0% | 0 | 0 | 2 |
| ObjectMgrClient.cpp | 89 | 12.8k | 5 (5.6%) | 7.4% | 0 | 0 | 23 |
...
| SLock.cpp | 68 | 12.3k | 0 (0.0%) | 0.0% | 0 | 0 | 18 |
| CGxD3d9ExTexture.cpp | 47 | 12.2k | 0 (0.0%) | 0.0% | 0 | 0 | 5 |
| CharacterCreation.cpp | 56 | 12.2k | 18 (32.1%) | 29.0% | 3 | 0 | 3 |
| aSfxDsp.cpp | 48 | 12.1k | 0 (0.0%) | 0.0% | 0 | 0 | 0 |
| EvtSched.cpp | 73 | 12.1k | 1 (1.4%) | 5.7% | 0 | 0 | 33 |
| SoundInterface2ZoneSounds.cpp | 68 | 11.6k | 1 (1.5%) | 0.4% | 0 | 0 | 23 |
| UIBindings.cpp | 59 | 11.5k | 17 (28.8%) | 33.5% | 15 | 0 | 4 |
...
| TradeFrame.cpp | 43 | 8.8k | 6 (14.0%) | 23.9% | 6 | 0 | 5 |
| vorbisfile.c | 23 | 8.6k | 0 (0.0%) | 0.0% | 0 | 0 | 0 |
| DanceStudio.cpp | 53 | 8.6k | 0 (0.0%) | 0.0% | 0 | 0 | 24 |
| DuelInfo.cpp | 50 | 8.5k | 0 (0.0%) | 0.0% | 0 | 0 | 5 |
...
| cmemblock.cpp | 46 | 6.7k | 9 (19.6%) | 16.4% | 0 | 0 | 16 |
| SSignature.cpp | 36 | 6.7k | 6 (16.7%) | 10.3% | 0 | 0 | 18 |
| SCmd.cpp | 55 | 6.6k | 2 (3.6%) | 0.2% | 0 | 0 | 16 |
...
| ClientServices.cpp | 37 | 6.1k | 0 (0.0%) | 0.0% | 0 | 0 | 0 |
...
| NetClient.cpp | 44 | 5.9k | 1 (2.3%) | 1.1% | 0 | 0 | 6 |
...
| OsURLDownload.cpp | 21 | 5.5k | 1 (4.8%) | 0.8% | 0 | 0 | 5 |
| GMTicketInfo.cpp | 37 | 5.3k | 6 (16.2%) | 14.4% | 6 | 0 | 1 |
| fmod.cpp | 110 | 5.2k | 1 (0.9%) | 0.9% | 0 | 0 | 42 |
| fmod_codec_mod.cpp | 10 | 5.0k | 0 (0.0%) | 0.0% | 0 | 0 | 1 |
| fmod_thread.cpp | 25 | 4.9k | 0 (0.0%) | 0.0% | 0 | 0 | 16 |
| fmod_file.cpp | 45 | 4.8k | 0 (0.0%) | 0.0% | 0 | 0 | 17 |
...
| ObjectAlloc.cpp | 41 | 4.6k | 4 (9.8%) | 11.5% | 0 | 0 | 20 |
...
| CSimpleMessageFrame.cpp | 29 | 4.2k | 1 (3.4%) | 1.1% | 0 | 0 | 0 |
| OsTcp.cpp | 23 | 4.2k | 0 (0.0%) | 0.0% | 0 | 0 | 0 |
| ShaderEffectManager.cpp | 24 | 4.1k | 0 (0.0%) | 0.0% | 0 | 0 | 3 |
| OsVersionHash.cpp | 19 | 4.1k | 0 (0.0%) | 0.0% | 0 | 0 | 1 |
| CharacterComponent.cpp | 11 | 4.0k | 1 (9.1%) | 28.8% | 0 | 0 | 5 |
| RCString.cpp | 46 | 4.0k | 3 (6.5%) | 14.4% | 0 | 0 | 17 |
...
| CSimpleFont.cpp | 25 | 3.8k | 1 (4.0%) | 29.3% | 0 | 0 | 1 |
...
| TimeManager.cpp | 34 | 3.3k | 2 (5.9%) | 3.6% | 0 | 0 | 5 |
...
| StableInfo.cpp | 15 | 2.7k | 0 (0.0%) | 0.0% | 0 | 0 | 0 |
...
| CharacterModelBase.cpp | 24 | 2.0k | 6 (25.0%) | 28.4% | 6 | 0 | 0 |
| floor0.c | 13 | 2.0k | 0 (0.0%) | 0.0% | 0 | 0 | 0 |
| ? | 15 | 0.8k | 1 (6.7%) | 3.7% | 0 | 0 | 7 |
...
| 004c6a40 | TextureBlob.cpp? | 1787 | 98 |  | <UNKNOWN ERROR>, MUSIC |
| 0061fec0 | Tooltip.cpp | 756 | 204 |  | %sTextLeft%d, %sTextRight%d |
| 00877e10 | ShaderEffectManager.cpp? | 501 | 243 |  |  -######## FMOD ERROR! (err %d) %s,  -######## TOO MANY ERRORS. NO FURTHER E |
...
| 00832ab0 | M2Scene.cpp? | 797 | 67 |  |  |
| 0082f0f0 | M2Scene.cpp? | 6267 | 7 |  |  |
| 006714a0 | DBClient.cpp? | 183 | 268 |  |  |
...
| 00960dd0 | CSimpleMovieFrame.cpp? | 485 | 0 | `CSimpleModel_GetLight` [table] |  |
...
| 00405dd0 | `ClientOpenArchives` | Country; Data\; Failed to open archive %s.; Failed to read data from the network. Please check |
...
| 00573690 | `Script_GetRaidRosterInfo` | MAINASSIST; MAINTANK; PLAYER_OFFLINE; Usage: GetRaidRosterInfo(index) |
...
|---|---|---:|---|
| `sendMTFValues` | lib/stormlib-9.31 | 15862 |  |
| `BZ2_decompress` | lib/stormlib-9.31 | 10472 |  |
...
| `doContent` | lib/expat-2.0 | 3900 |  |
| `LzmaDec_DecodeReal` | lib/stormlib-9.31 | 3776 |  |
...
| `mainSort` | lib/stormlib-9.31 | 2682 |  |
...
| `fallbackSort` | lib/stormlib-9.31 | 2271 |  |
...
| addr | whoa | fidelity | ref calls | whoa calls | size |
|---|---|---:|---:|---:|---:|
| 0051d9b0 | `CGGameUI::RegisterGameCVars` | 46% | 192 | 89 | 6776 |
| 0087c710 | `SESound::Init` | 0% | 230 | 43 | 6078 |
| 006909a0 | `CGxDeviceGLES::ISetCaps` | 0% | 206 | 7 | 3789 |
| 004dab40 | `CGlueMgr::PollAccountLogin` | 7% | 148 | 30 | 3696 |
| 00485f40 | `CSimpleTexture::LoadXML` | 41% | 61 | 64 | 3017 |
| 00526530 | `ReceiveWeather` | 0% | 115 | 6 | 2495 |
| 005fd910 | `CameraRegisterCVars` | 1% | 68 | 1 | 2475 |
| 004d1600 | `SI2::RegisterUserCVars` | 28% | 79 | 30 | 2232 |
| 0079e7c0 | `CMap::MapMemInitialize` | 31% | 45 | 28 | 2068 |
| 00455f10 | `TEST_CASE` | 0% | 40 | 6583 | 2021 |
| 004932c0 | `CSimpleFrame::LoadXML` | 46% | 69 | 63 | 1858 |
| 0096e9c0 | `StringToClickAction` | 9% | 64 | 6 | 1741 |
| 0045cb20 | `QueryMpqSignatureInfo` | 0% | 55 | 6 | 1714 |
| 00405dd0 | `ClientOpenArchives` | 14% | 50 | 25 | 1706 |
| 007e18c0 | `ValidateNameInitialize` | 0% | 10 | 4 | 1475 |
| 004873e0 | `CSimpleFontString::LoadXML` | 56% | 63 | 64 | 1441 |
| 0087b5f0 | `SEDiskSound::CompleteNonBlockingLoad` | 0% | 33 | 10 | 1395 |
| 00631000 | `CGTooltip_SetAction` | 4% | 51 | 7 | 1377 |
| 007e4480 | `BlobShadowsBegin` | 3% | 33 | 17 | 1370 |
| 0087ee60 | `SESound::LoadDiskSound` | 20% | 29 | 35 | 1303 |
| 0069ed50 | `CGxDeviceGLL::PatchVertexShader` | 20% | 10 | 9 | 1299 |
| 0052a980 | `CGGameUI::Initialize` | 10% | 59 | 29 | 1267 |
| 004f1a20 | `CCharacterComponent::Initialize` | 9% | 10 | 11 | 1189 |
| 0096fed0 | `CSimpleButton::LoadXML` | 45% | 46 | 49 | 1174 |
| 00497070 | `CSimpleFont::LoadXML` | 52% | 36 | 48 | 1155 |
| 0076a630 | `RegisterGxCVars` | 61% | 28 | 17 | 1144 |
| 00401b60 | `ClientRegisterConsoleCommands` | 30% | 33 | 12 | 1126 |
| 0060abf0 | `Script_GetGUIDFromToken` | 48% | 42 | 36 | 1121 |
| 00813ee0 | `FrameXML_ProcessFile` | 52% | 42 | 46 | 1104 |
| 0040a270 | `Paint` | 6% | 27 | 32 | 1055 |
| 004f8ea0 | `CGWorldFrame::OnWorldRender` | 0% | 59 | 104 | 1016 |
| 00967290 | `CSimpleEditBox::LoadXML` | 60% | 36 | 42 | 989 |
| 008ce200 | `FindPatchPrefix_SC2_ArchiveName` | 0% | 42 | 12 | 951 |
| 004da5f0 | `CGlueMgr::Resume` | 15% | 47 | 45 | 909 |
| 004d9bd0 | `CGlueMgr::EnterWorld` | 44% | 38 | 39 | 895 |
| 0048fef0 | `CSimpleFrame::LoadXML_Scripts` | 36% | 24 | 42 | 889 |
| 0061eb40 | `CGTooltip_SetOwner` | 27% | 33 | 15 | 836 |
| 008bfe80 | `EffectGlow::EffectGlow` | 4% | 28 | 1 | 834 |
| 0081bb20 | `Script_CreateFrame` | 42% | 40 | 43 | 832 |
| 0049f2d0 | `CSimpleFrame_GetAttribute` | 35% | 27 | 34 | 831 |
