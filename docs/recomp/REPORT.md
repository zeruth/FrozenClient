...
Generated 2026-09-24 01:34 by `tools/recomp/recomp.py`. Do not edit; put facts in `tools/recomp/overrides.json`
...
| mapped to a frozen function | 3160 (+3) (11.6%) | 706.3k (12.8%) |
| &nbsp;&nbsp;ported | 2410 (+2) | 521.6k |
| &nbsp;&nbsp;stub (unimplemented body) | 690 (=) | 137.7k |
| &nbsp;&nbsp;verified (override) | 14 (=) | 3.0k |
| **faithful** (linked, not stub, call order >= 80%) | **1236 (+2) (4.6%)** | **163.8k (3.0%)** |
| unmapped | 24000 | 4.70M |
| world spine (reachable from OnFrameRender) | 5529, mapped 556 (+3) (10.1%) | |
| &nbsp;&nbsp;render spine (world update + map + M2 scene) | 5797, mapped 566 (+3) (9.8%) | |
| **render surface** (the modules that draw the world) | **4589, mapped 273 (+1) (5.9%)** | |
| frozen functions (src/, from PDB + source) | 12260, stubs 1819 | |

Match evidence: annotated 933, callgraph 181, callorder 127, cvar 32, handler 29, order 150, override 260, sticky 22, string 319, table 1107. Module anchors: 1479 assert strings.

`order` and `sticky` are POSITIONAL: neither says anything about what the function does, only where it sits. `order` lays frozen's definitions onto the reference's addresses between two anchors whenever the two counts happen to be equal, so one unported function or one helper frozen invented shifts every pair in the run. It has been checked closely three times, each time because a fresh tag put a run next to something already read, and all three runs were wrong. Treat a link of either kind as a question. See tools/recomp/README.md under the order matcher.

Previous run: 2026-09-24 01:27 -- mapped 3157, ported 2408, stub 690, spine mapped 553.
...
| CSimpleHyperlinkedFrame.cpp | 198 | 46.2k | 31 (15.7%) | 14.7% | 0 | 0 | 120 |
...
| TextureBlob.cpp | 214 | 34.6k | 25 (11.7%) | 16.0% | 0 | 0 | 84 |
