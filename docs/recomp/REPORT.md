...
Generated 2026-09-24 05:52 by `tools/recomp/recomp.py`. Do not edit; put facts in `tools/recomp/overrides.json`
...
| mapped to a frozen function | 3202 (=) (11.8%) | 713.6k (12.9%) |
| &nbsp;&nbsp;ported | 2453 (=) | 529.3k |
| &nbsp;&nbsp;stub (unimplemented body) | 689 (=) | 137.3k |
| &nbsp;&nbsp;verified (override) | 14 (=) | 3.0k |
| **faithful** (linked, not stub, call order >= 80%) | **1269 (=) (4.7%)** | **168.7k (3.1%)** |
| unmapped | 23954 | 4.69M |
| world spine (reachable from OnFrameRender) | 5527, mapped 585 (=) (10.6%) | |
| &nbsp;&nbsp;render spine (world update + map + M2 scene) | 5795, mapped 595 (=) (10.3%) | |
| **render surface** (the modules that draw the world) | **4589, mapped 282 (=) (6.1%)** | |
| frozen functions (src/, from PDB + source) | 12329, stubs 1818 | |

Match evidence: annotated 974, callgraph 183, callorder 127, cvar 32, handler 29, order 150, override 260, sticky 21, string 319, table 1107. Module anchors: 1479 assert strings.

`order` and `sticky` are POSITIONAL: neither says anything about what the function does, only where it sits. `order` lays frozen's definitions onto the reference's addresses between two anchors whenever the two counts happen to be equal, so one unported function or one helper frozen invented shifts every pair in the run. It has been checked closely three times, each time because a fresh tag put a run next to something already read, and all three runs were wrong. Treat a link of either kind as a question. See tools/recomp/README.md under the order matcher.

Previous run: 2026-09-24 05:52 -- mapped 3202, ported 2453, stub 689, spine mapped 585.
...
| CSimpleHyperlinkedFrame.cpp | 196 | 45.7k | 60 (30.6%) | 26.5% | 0 | 0 | 120 |
...
| TextureBlob.cpp | 214 | 34.6k | 28 (13.1%) | 16.6% | 0 | 0 | 84 |
