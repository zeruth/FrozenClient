...
|---|---|---|
| **Linked** | an original function has a known counterpart here | **3,231 / 27,156** &nbsp;·&nbsp; ~11% |
| **Faithful** | linked, not a stub, and reproduces ≥80% of the original's call sequence in order | **1,293** &nbsp;·&nbsp; ~4% of the client, ~38% of what is linked |
...
| Functions reachable from the world render entry point | 613 / 5,527 &nbsp;·&nbsp; ~11% |
