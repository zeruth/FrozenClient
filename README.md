...
|---|---|---|
| **Linked** | an original function has a known counterpart here | **3,228 / 27,156** &nbsp;·&nbsp; ~11% |
| **Faithful** | linked, not a stub, and reproduces ≥80% of the original's call sequence in order | **1,289** &nbsp;·&nbsp; ~4% of the client, ~38% of what is linked |
...
| Functions reachable from the world render entry point | 610 / 5,527 &nbsp;·&nbsp; ~11% |
