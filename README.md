...
|---|---|---|
| **Linked** | an original function has a known counterpart here | **3,077 / 27,161** &nbsp;·&nbsp; ~11% |
| **Faithful** | linked, not a stub, and reproduces ≥80% of the original's call sequence in order | **1,139** &nbsp;·&nbsp; ~4% of the client, ~37% of what is linked |
...
| Functions reachable from the world render entry point | 495 / 5,530 &nbsp;·&nbsp; ~9% |
| The render surface: the map, model, entity, texture and device modules that draw the world | 230 / 6,004 &nbsp;·&nbsp; **~4%** |
