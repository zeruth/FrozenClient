...
|---|---|---|
| **Linked** | an original function has a known counterpart here | **3,106 / 27,160** &nbsp;·&nbsp; ~11% |
| **Faithful** | linked, not a stub, and reproduces ≥80% of the original's call sequence in order | **1,192** &nbsp;·&nbsp; ~4% of the client, ~38% of what is linked |
...
| Functions reachable from the world render entry point | 510 / 5,529 &nbsp;·&nbsp; ~9% |
| The render surface: the map, model, entity, texture and device modules that draw the world | 252 / 4,589 &nbsp;·&nbsp; **~5%** |
