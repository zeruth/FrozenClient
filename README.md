...
|---|---|---|
| **Linked** | an original function has a known counterpart here | **3,083 / 27,160** &nbsp;·&nbsp; ~11% |
...
| The render surface: the map, model, entity, texture and device modules that draw the world | 235 / 4,589 &nbsp;·&nbsp; **~5%** |
