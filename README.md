...
|---|---|---|
| **Linked** | an original function has a known counterpart here | **3,157 / 27,160** &nbsp;·&nbsp; ~11% |
| **Faithful** | linked, not a stub, and reproduces ≥80% of the original's call sequence in order | **1,234** &nbsp;·&nbsp; ~4% of the client, ~38% of what is linked |
