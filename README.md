...
|---|---|---|
| **Linked** | an original function has a known counterpart here | **3,151 / 27,160** &nbsp;·&nbsp; ~11% |
| **Faithful** | linked, not a stub, and reproduces ≥80% of the original's call sequence in order | **1,230** &nbsp;·&nbsp; ~4% of the client, ~38% of what is linked |
...
| Functions reachable from the world render entry point | 548 / 5,529 &nbsp;·&nbsp; ~9% |
